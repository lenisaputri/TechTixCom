...
AND (tstp.tanggal_praktek BETWEEN '$from' AND '$end')");
while($lihat=mysqli_fetch_array($query)){
	...
	$pdf->Cell(2.8, 0.8, $lihat['tanggal_praktek'], 1, 1,'C');
	$no++;
}
...
$pdf->Output("Laporan-Full-Nilai-Technical-Praktek-Online-Training.pdf","I");

...
<div class="card shadow mb-4">
  ...
  <div class="card-body">
  <?php 
        $resultTampilScoreSafetyDetailOperator = tampilScoreSafetyDetailOperator($con, $idUser);

        if (mysqli_num_rows($resultTampilScoreSafetyDetailOperator) > 0){
          while ($rowDetailData = mysqli_fetch_assoc($resultTampilScoreSafetyDetailOperator)) {
            ?>
  <div class="row">
                    <div class="col-sm-6">
                ...
                <hr>
                <?php 
                $resultTampilScoreSafetyDetailNilaiOperator = tampilScoreSafetyDetailNilaiOperator($con, $idUser);

                if (mysqli_num_rows($resultTampilScoreSafetyDetailNilaiOperator) > 0){
                    ?>
                        <div class="table-responsive">
                                <table class="table table-bordered text-center" width="100%" cellspacing="0">
                                    ...
                                    <?php 
                                            $index=1;
                                            while($row1 = mysqli_fetch_assoc($resultTampilScoreSafetyDetailNilaiOperator)){
                                                ?>
                                                 <tr>

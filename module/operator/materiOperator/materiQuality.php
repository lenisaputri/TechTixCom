<?php
  ...
  include "../process/proses_materiQualityOperator.php";
?>
...
<div class="container-fluid" id="materiOperator">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Materi Quality</h6>   
        </div>
        <div class="card-body">
            <?php
                $resultTampilMateriQuality = tampilMateriQuality($con);
                $index=1;
                if (mysqli_num_rows($resultTampilMateriQuality) > 0){
            ?>
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                <div class="panel panel-default">
                <?php
                        while ($row = mysqli_fetch_assoc($resultTampilMateriQuality)) {
                    ?>
            ...
            <?php
                    ...
                    ?>
                        <div class="text-center">
                            <p class="text-muted">Data Materi Quality kosong!!</p>
                        </div>
                    <?php
                }
                ?>

...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2020 at 03:48 AM
...
(15, 'oo', 'llo', 'o', 'Pedoman-Kebutuhan-Penguasaan-Teknik-Berbasis-Industri-Aplikasi-dan-Pengembang-Permainan.pdf', 'file', '2020-01-28');
...
--
ALTER TABLE `tabel_score_safety`
  MODIFY `id_score_safety` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tabel_score_safety_detail`
--
ALTER TABLE `tabel_score_safety_detail`
  MODIFY `id_score_safety_detail` int(11) NOT NULL AUTO_INCREMENT;

...
$query=mysqli_query($con,"SELECT tstp.*, tp.id_operator, tp.nik, tp.nama as nama_lengkap, tj.nama as nama_jabatan 
...
AND tstp.id_score_technical_praktek = '".$_GET['id_score_technical_praktek']."'");
...
$pdf->Cell(190 ,7,'HASIL NILAI TRAINING TECHNICAL PRAKTEK',0,1,'C');//end of line
...
$pdf->SetFont('Arial','',11);
$pdf->Cell(35 ,5,'Kategori Praktek    :',0,0);
$pdf->Cell(90 ,5, $row['kategori_technical'],0,1);
$pdf->Cell(100 ,2,'',0,1);//end of line

$pdf->SetFont('Arial','B',11);
$pdf->Cell(130 ,5,'',0,0);
$pdf->Cell(38 ,5,'Tanggal Praktek    :',0,0);
$pdf->Cell(25 ,5,$row['tanggal_praktek'],0,1);//end of line
...
$pdf->Output("Laporan-Nilai-Technical-Praktek-Training.pdf","I");
?>